        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Сalories = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    CopmanyName = table.Column<string>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DishUser", x => new { x.AuthorsId, x.DishesId });
                    table.ForeignKey(
                        name: "FK_DishUser_Dishes_DishesId",
                        column: x => x.DishesId,
                        principalTable: "Dishes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DishUser_Users_AuthorsId",
            ...
            migrationBuilder.InsertData(
                table: "Roles",
                columns: new[] { "Id", "Name" },
                values: new object[] { new Guid("2690036f-03ab-4483-a5b0-4b9be18dc499"), "Администратор" });

            migrationBuilder.InsertData(
                table: "Roles",
                columns: new[] { "Id", "Name" },
                values: new object[] { new Guid("c021e800-8cc7-4d71-925d-219120e7d67a"), "Повар" });

            migrationBuilder.InsertData(
                table: "Roles",
                columns: new[] { "Id", "Name" },
                values: new object[] { new Guid("fbadc424-0e28-4ed1-af49-ee11c43fb957"), "Кассир" });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "BirthDay", "FIO", "Password", "RoleId", "UserName" },
                values: new object[] { new Guid("eab6a7f2-1d25-40dc-afd7-d050899e105e"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Иванов Иван Иванович", "admin", new Guid("2690036f-03ab-4483-a5b0-4b9be18dc499"), "admin" });
